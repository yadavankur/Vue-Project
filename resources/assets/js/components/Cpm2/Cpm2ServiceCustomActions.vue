<template>
    <div>
        <div class="cpmservice-custom-actions text-center">
...
<script>
    ...
    {   components: {     },
        ...
        mounted() {  },
        updated() {  console.log('/cpm2/Cpm2ServiceCustomActions.vue--- Component updated.');   },
        created() {  console.log('/cpm2/Cpm2ServiceCustomActions.vue--- created: ', this.rowData, this.rowIndex);  },
        methods: {   itemAction (action, data, index) 
                        {  console.log('/cpm2/Cpm2ServiceCustomActions.vue---itemAction: CustomAction:action-item :' + action, data, index);
