<template>
    <div>
        <div class="cpmmaster-custom-actions text-center">
...
<script>
    export default {
        ...
        updated() {
            console.log('CpmMasterCustomActions Component updated.');
        },
        created() {
            console.log('CpmMasterCustomActions created: ', this.rowData, this.rowIndex);
        },
        methods: {
