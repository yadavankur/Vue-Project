<template>
    <div>
        <div class="deviceType-custom-actions text-center">
...
<script>
    export default {
        ...
        updated() {
            console.log('DeviceTypeCustomActions Component updated.');
        },
        created() {
            console.log('DeviceTypeCustomActions created: ', this.rowData, this.rowIndex);
        },
        methods: {
