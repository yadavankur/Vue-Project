<template>
    <div>
        <div class="group-custom-actions text-center">
...
<script>
    export default {
        ...
        updated() {
            console.log('GroupCustomActions Component updated.');
        },
        created() {
            console.log('GroupCustomActions created: ', this.rowData, this.rowIndex);
        },
        methods: {
