...
<script>
    ...
    import TabCustomActions from './TabCustomActions.vue'
    import TabCustomFilterBar from './TabCustomFilterBar.vue'
//    import VueSweetAlert from 'vue-sweetalert'
//    import VueEvents from 'vue-events'
//    Vue.use(VueEvents);
//    Vue.use(VueSweetAlert);

    Vue.component('tab-custom-actions', TabCustomActions);
    //Vue.component('tab-custom-filter-bar', TabCustomFilterBar);

    export default 
    {
        computed: {   url(){ return api.currentTabNodes;  }    },
        props: {     },
        components: {  Vuetable, VuetablePagination, VuetablePaginationInfo,'tab-custom-filter-bar': TabCustomFilterBar, },
        ...
        events: {
            ...
            'refreshTabTable'() {
                console.log('events -> refreshTabTable');
                Vue.nextTick( () => this.$refs.tabvuetable.refresh() );
            }
        },
        watch: {
            'perPage' (newVal, oldVal) {
                this.$nextTick(function() {
                    this.$refs.tabvuetable.refresh()
                })
            },
            'paginationComponent' (newVal, oldVal) {
                this.$nextTick(function() {
                    this.$refs.tabpagination.setPaginationData(this.$refs.tabvuetable.tablePagination)
                })
            },
            url() {
