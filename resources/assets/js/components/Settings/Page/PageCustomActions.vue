<template>
    <div>
        <div class="page-custom-actions text-center">
...
<script>
    export default {
        ...
        updated() {
            console.log('PageCustomActions Component updated.');
        },
        created() {
            console.log('PageCustomActions created: ', this.rowData, this.rowIndex);
        },
        methods: {
