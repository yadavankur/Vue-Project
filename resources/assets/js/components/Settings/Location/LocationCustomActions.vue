<template>
    <div>
        <div class="location-custom-actions text-center">
...
<script>
    ...
    {   components: {  },
        ...
        data () { return {  actAdd: false,
                            actEdit: { type: Boolean, default: true },
                            actDelete: { type: Boolean, default: true  },
                         }
                },
        mounted() {    },
        updated() {  console.log('LocationCustomActions Component updated.');    },
        created() {  console.log('LocationCustomActions created: ', this.rowData, this.rowIndex);   },
