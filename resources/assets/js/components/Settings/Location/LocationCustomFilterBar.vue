...
<script>
    ...
    {   data () { return { filterText: ''}  },
        methods: 
        {   doFilter () { this.$events.fire('location-filter-set', this.filterText)  },
            resetFilter () { this.filterText = ''; this.$events.fire('location-filter-reset') },
            onClickNew() { console.log('LocationCustomFilterBar onClickNew');
