<template>
    <div>
        <div class="permission-custom-actions text-center">
...
<script>
    export default {
        ...
        updated() {
            console.log('PermissionCustomActions Component updated.');
        },
        created() {
            console.log('PermissionCustomActions created: ', this.rowData, this.rowIndex);
        },
        methods: {
