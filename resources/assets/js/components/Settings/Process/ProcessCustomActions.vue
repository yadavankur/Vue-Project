<template>
    <div>
        <div class="process-custom-actions text-center">
...
<script>
    export default {
        ...
        updated() {
            console.log('ProcessCustomActions Process updated.');
        },
        created() {
            console.log('ProcessCustomActions created: ', this.rowData, this.rowIndex);
        },
        methods: {
