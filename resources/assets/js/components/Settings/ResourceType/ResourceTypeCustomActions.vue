<template>
    <div>
        <div class="resourceType-custom-actions text-center">
...
<script>
    export default {
        ...
        updated() {
            console.log('ResourceTypeCustomActions Component updated.');
        },
        created() {
            console.log('ResourceTypeCustomActions created: ', this.rowData, this.rowIndex);
        },
        methods: {
