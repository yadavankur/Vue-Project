...
<script>
    export default {
        ...
        methods: {
            doFilter () {
                this.$events.fire('resource-type-filter-set', this.filterText)
            },
            resetFilter () {
                this.filterText = '';
                this.$events.fire('resource-type-filter-reset')
            },
            onClickNew() {
                console.log('ResourceTypeCustomFilterBar onClickNew');
