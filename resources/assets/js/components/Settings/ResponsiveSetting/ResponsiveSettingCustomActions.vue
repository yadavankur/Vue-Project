<template>
    <div>
        <div class="responsiveSetting-custom-actions text-center">
...
<script>
    export default {
        ...
        updated() {
            console.log('ResponsiveSettingCustomActions Component updated.');
        },
        created() {
            console.log('ResponsiveSettingCustomActions created: ', this.rowData, this.rowIndex);
        },
        methods: {
