...
<script>
    export default {
        ...
        methods: {
            doFilter () {
                this.$events.fire('responsive-setting-filter-set', this.filterText)
            },
            resetFilter () {
                this.filterText = '';
                this.$events.fire('responsive-setting-filter-reset')
            },
            onClickNew() {
                console.log('ResponsiveSettingCustomFilterBar onClickNew');
