<template>
    <div>
        <div class="component-custom-actions text-center">
...
<script>
    export default {
        ...
        updated() {
            console.log('ComponentCustomActions Component updated.');
        },
        created() {
            console.log('ComponentCustomActions created: ', this.rowData, this.rowIndex);
        },
        methods: {
