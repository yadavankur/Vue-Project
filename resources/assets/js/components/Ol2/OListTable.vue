...
<script>
    ...
    import OrderListCustomFilterBar from './OListCustomFilterBar.vue'
    import moment from 'moment'

    export default 
    { beforeCreate() { console.log('/Ol2/OListTable.vue-beforecreate!')   },
      computed: 
        { selectedRow() 
      ...
      data () 
        ...
        methods: 
        {
            ...
            {   console.log('/Ol2/OListTable.vue-onRadioChecked isChecked=', isChecked);
                console.log('/Ol2/OListTable.vue-%%%%%%%%%%%% onRadioChecked dataItem=', dataItem);
            ...
            onActions (data) 
            {   console.log('/Ol2/OListTable.vue-orderListTable onActions', data);   },
            onLoading() 
            {   console.log('/Ol2/OListTable.vue-loading... show your spinner here ie- onloading -call api via vue-resource') },
            onLoaded() 
            {  console.log('/Ol2/OListTable.vue-loaded! .. hide your spinner here')    }
        },
        events: 
        { 'order-list-filter' (filterData) 
             { console.log('/Ol2/OListTable.vue-OrderListTable order-list-set filterData=', filterData);
            ...
            'order-list-reset' () 
            {   console.log('/Ol2/OListTable.vue-OrderListTable order-list-set');
            ...
            {   console.log('/Ol2/OListTable.vue-events -> refreshOrderListTable');
                Vue.nextTick( () => this.$refs.orderVuetable.refresh() );
            }
        },
        watch: 
        {      'perPage' (newVal, oldVal)
               ...
               selectedRow() 
                 {  console.log('/Ol2/OListTable.vue-watch +++++++ selectedRow() = ', this.selectedRow);
                 }
        },
    }
</script>
