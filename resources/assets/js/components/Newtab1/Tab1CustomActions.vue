<template>
    <div>
        <div class="tab-custom-actions text-center">
...
<script>
    ...
    { components: {   },
      ...
      data () { return { actAdd: false, actEdit: {  type: Boolean,  default: true },
        ...
        mounted() {   },
        updated() {  console.log('/components/settings/tab/TabCustomActions.vue--TabCustomActions Component updated.');   },
        created() {  console.log('/components/settings/tab/TabCustomActions.vue--TabCustomActions created: ', this.rowData, this.rowIndex);  },
        methods: {  itemAction (action, data, index) 
                     {   console.log('/components/settings/tab/TabCustomActions.vue--itemAction: CustomAction:action-item :' + action, data, index);
