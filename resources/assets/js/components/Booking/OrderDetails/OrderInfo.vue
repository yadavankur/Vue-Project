            ...
            <div id="orderinfo" class="panel-collapse collapse in table-responsive">
              <table class="table table-hover table-striped table-responsive table-bordered table-condensed">
                ...
                <tr><td>Location</td><td colspan="2"> {{order? order.QUOTE_NUM_PREF : ''}}</td></tr>
                  ...
                  <tr><td>Status </td><td colspan="2">{{ order && order.status? order.status.DESCR : ''}}
                    </td>
                  </tr>
                </tbody>
              </table>
...
{    computed: 
        {  ...mapGetters({    }),
          ...
          color() {  if (this.details && this.details.color)
    ...
    {  onClickChangeAddress() 
        {   console.log('onClickChangeAddress');
            this.onOpenChangeChangeAddressModal();
        },
        onOpenChangeChangeAddressModal() 
        {   console.log('onOpenChangeChangeAddressModal');
