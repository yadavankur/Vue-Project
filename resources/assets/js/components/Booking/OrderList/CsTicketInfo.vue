    ...
    <div class="app-row">
        <div class="panel panel-primary">
            <div class="panel-heading">
              <a class="accordion-toggle" data-toggle="collapse"  href="#csticketinfoo"> Customer Service Tickets</a>
              ...
              <table class="table table-hover table-striped table-responsive table-bordered table-condensed">
                ...
                <tbody>
                  <tr v-for="csticket in csticket">
                    <td> {{ csticket.ticket_no }} </td>
                    <td> {{ formatDatetime(csticket.created_at) }}</td>
                    <td> {{ csticket.description }} </td>
                    <td> {{ csticket.comment }} </td>
                    <td> {{ csticket.status }} </td>
