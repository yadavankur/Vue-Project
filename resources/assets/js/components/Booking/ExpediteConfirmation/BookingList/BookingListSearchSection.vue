<template>
    <div id="root-ec-booking-list-search">
        <div class="app-row" >
...
<script>
    ...
    export default {
        ...
        created() {
            console.log('ECBookingListSearchSection vue created!');
            this.$store.dispatch('getOrderStatusOptions')
                .then((response) => {
                    console.log('/bookinglistsearchsection.vue-created getOrderStatusOptions success=', response);
                    this.setOrderStatusOptions(response.data);
                })
                .catch((error) => {
                    console.error('/bookinglistsearchsection.vue-getAssignedLocationOptions error=', error);
                });
            this.$store.dispatch('getAssignedLocationOptions')
                .then((response) => {
                    console.log('/bookinglistsearchsection.vue-created getAssignedLocationOptions success=', response);
        ...
        methods: {
            onChangeDateRange(val) {
                console.log('/bookinglistsearchsection.vue-onChangeDateRange val=',val);
                this.formSearchData.dateRange = val;
            },
            onChangeLocation(val) {
                console.log('/bookinglistsearchsection.vue-onChangeLocation val=',val);
            },
            onChangeStatus(val) {
                console.log('/bookinglistsearchsection.vue-onStatusLocation val=',val);
            },
            setOrderStatusOptions(statuses) {
                console.log('/bookinglistsearchsection.vue-setOrderStatusOptions statuses=',statuses);
                let options = [];
            ...
            setAssignedLocationOptions(locations) {
                console.log('/bookinglistsearchsection.vue-setAssignedLocationOptions locations=',locations);
                let options = [];
            ...
            doFilter () {
                console.log('/bookinglistsearchsection.vue-ECBookingListSearchSection doFilter');
                this.$events.fire('ec-booking-list-filter', this.formSearchData)
            },
            resetFilter () {
                console.log('/bookinglistsearchsection.vue-ECBookingListSearchSection resetFilter');
                this.resetFormData();
                this.$events.fire('ec-booking-list-reset', this.formSearchData)
            },
            resetFormData() {
                this.formSearchData =  {
