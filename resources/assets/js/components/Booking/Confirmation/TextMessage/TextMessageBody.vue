...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.smsType == 'Credit')
            {
                // for money owing template
                this.templateOptions = [
                    { value: 'SINGLE_TEXT_MONEY_OWING', label: 'For Payment Reminder' },
                ];
                this.formData.optionType = 'SINGLE_TEXT_MONEY_OWING';
                this.formData.type = 'TEXT_MESSAGE_MONEY_OWING';
            }
            else
            {
                ...
                this.formData.optionType = 'SINGLE_TEXT_ORDER_CONFIRMATION';
                this.formData.type = 'TEXT_MESSAGE';
            }
            if (this.order)
            {
