<template>
    <div>
        <div class="tier-custom-actions text-center">
...
<script>
    export default {
        ...
        updated() {
            console.log('TierCustomActions Component updated.');
        },
        created() {
            console.log('TierCustomActions created: ', this.rowData, this.rowIndex);
        },
        methods: {
