...
<script>
    export default {
        ...
        methods: {
            doFilter () {
                this.$events.fire('customer-tier-level-filter-set', this.filterText)
            },
            resetFilter () {
                this.filterText = '';
                this.$events.fire('customer-tier-level-filter-reset')
            },
            onClickNew() {
                console.log('CustomTierLevelFilterBar onClickNew');
