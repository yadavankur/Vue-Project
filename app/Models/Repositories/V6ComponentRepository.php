...
class V6ComponentRepository extends BaseRepository
{
    public function model() {
        return 'App\Models\Entities\V6BomComp';
    }
    public function getByPaginate($request)
    {
        ...
        $query = $this->model->select([
            ...
            ->join('V_V6_QUOTE_ITEM', 'V_V6_BOM_COMP.QUOTE_ITEM_ID', '=', 'V_V6_QUOTE_ITEM.QUOTE_ITEM_ID')
        ...
        if ($search) {
            ...
            $query = $query->where(function ($query) use ($like) {
                $query->where('V_V6_BOM_COMP.DESCR', 'LIKE', $like);
            });
        }
