...
class CreateTickettype5sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tickettype5s', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamps();
            ...
            $table->integer('errorcodeid')->nullable();
    ...
    {
        Schema::dropIfExists('tickettype5s');
    }
}
